...
class Hexagon(Polygon):
    ...
    def is_regular(self):
        ...
        # Since all sides and angles are equal in this class, it's always a regular hexagon.
        return True

    def centroid(self):
        """Return the coordinates of the centroid of the hexagon."""
        # For a regular hexagon centered at the origin, the centroid is also at the origin.
        return (0, 0)
